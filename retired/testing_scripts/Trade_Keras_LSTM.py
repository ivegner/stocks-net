...
aapl = data_builder.build_data(["WIKI/AAPL"], start_date="2015-01-01", end_date="2016-01-01")
one_input_length = len(aapl[0]["X"][0])

# securities == [stock1_dict, stock2_dict, stock3_dict]
securities = [
    data_builder.build_data([x], start_date="2014-01-01", end_date="2016-01-01") for x in test_secs
]
